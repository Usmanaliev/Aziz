...
const regions = {
  Uz: {
    tash: 'Toshkent shaxar',
    tashObl: 'Toshkent viloyati',
    jizakh: 'Jizzax viloyati',
    ...
    qashq: 'Qashqadaryo viloyati',
    surxan: 'Surxondaryo viloyati',
    qaraqalpok: 'Qoraqalpogʻiston Respublikasi',
    khorezm: 'Xorazm viloyati'
  },
  UzCir: {
    tash: 'Ташкент шахар',
    tashObl: 'Ташкент вилояти',
    jizakh: 'Жиззах вилояти ',
    sirdaryo: 'Сирдарё вилояти',
    bukhoro: 'Бухоро вилояти',
    samarkand: 'Самарқанд вилояти',
    navoi: 'Навоий вилояти',
    namangan: 'Наманган вилояти',
    andijan: 'Андижанская вилояти',
    fergana: 'Ферганская вилояти',
    qashq: 'Кашкадарьинская вилояти',
    surxan: 'Сурхандарьинская вилояти',
    qaraqalpok: 'Қорақалпоғистон Республикаси',
    khorezm: 'Хоразм вилояти'
  },
  Ru: {
    tash: 'город Ташкент',
    tashObl: 'Ташкентская область',
    jizakh: 'Джизакская область',
    sirdaryo: 'Сырдарьинская область',
    bukhoro: 'Бухарская область',
    ...
    qashq: 'Кашкадарьинская область',
    surxan: 'Сурхандарьинская область',
    qaraqalpok: 'Республика Каракалпакстан',
